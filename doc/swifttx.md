...
This mechanism has been integrated into Bitcore-Node-PIPOCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PIPOCOIN-Project/insight-api-pipocoin#web-socket-api](https://github.com/PIPOCOIN-Project/insight-api-pipocoin#web-socket-api) 
* API: [https://github.com/PIPOCOIN-Project/insight-api-pipocoin#swifttx-transactions](https://github.com/PIPOCOIN-Project/insight-api-pipocoin#swifttx-transactions) 
...
By default, the PIPOCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PIPOCOIN Core daemon:
