...
In order to support loading of multiple wallets in pipocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pipocoin.cpp.
...
Changes to pipocoin.cpp
----------------------
pipocoin.cpp is the entry point into pipocoin-qt, and as such, will require some minor modifications to provide hooks for
