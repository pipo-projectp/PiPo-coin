...
RESOURCES += src/qt/pipocoin.qrc src/qt/pipocoin_locale.qrc

TRANSLATIONS += src/qt/locale/pipocoin_bg.ts \
                src/qt/locale/pipocoin_de.ts \
                src/qt/locale/pipocoin_en.ts \
                src/qt/locale/pipocoin_es.ts \
                src/qt/locale/pipocoin_fi.ts \
                src/qt/locale/pipocoin_fr.ts \
                src/qt/locale/pipocoin_it.ts \
                src/qt/locale/pipocoin_ja.ts \
                src/qt/locale/pipocoin_pl.ts \
                src/qt/locale/pipocoin_pt.ts \
                src/qt/locale/pipocoin_ru.ts \
                src/qt/locale/pipocoin_sk.ts \
                src/qt/locale/pipocoin_sv.ts \
                src/qt/locale/pipocoin_vi.ts \
                src/qt/locale/pipocoin_zh_CN.ts \
                src/qt/locale/pipocoin_zh_TW.ts
