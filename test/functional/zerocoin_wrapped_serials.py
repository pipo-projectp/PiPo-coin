#!/usr/bin/env python3
# Copyright (c) 2019 The PIPOCOIN Core developers
...
from fake_stake.base_test import PIPOCOIN_FakeStakeTest

class zPIPOwrappedSerialsTest(PIPOCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPIPOs..." % DENOM_TO_USE)
