                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPIPOPathCustom = GetArg("-zpipobackuppath", "");
    ...
    if(!strzPIPOPathCustom.empty()) {
        ui->wallet_customzpipobackuppath->setText(QString::fromStdString(strzPIPOPathCustom));
        ui->wallet_customzpipobackuppath_label->setVisible(true);
        ui->wallet_customzpipobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPIPOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PIPOCOIN RPC console.") + "<br>" +
