...
/** Utility functions used by the PIPOCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render PIPOCOIN addresses in monospace font
...
// Parse "pipocoin:" URI into recipient object, return true on successful parsing
