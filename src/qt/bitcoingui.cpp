                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PIPOCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPIPO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PIPOCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about PIPOCOIN Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for PIPOCOIN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PIPOCOIN Core help message to get a list with possible PIPOCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PIPOCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PIPOCOIN network", "", count));
}
...
{
    QString strTitle = tr("PIPOCOIN Core"); // default title
