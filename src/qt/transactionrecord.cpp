...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zpipoTracker->HasMintTx(hash))) {
            //zPIPO stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZPIPO;
...
bool IsZPIPOType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZPIPO:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZPIPO || type == TransactionRecord::MNReward) {
