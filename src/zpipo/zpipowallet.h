...
#ifndef PIPOCOIN_ZPIPOWALLET_H
#define PIPOCOIN_ZPIPOWALLET_H
...
public:
    CzPIPOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPIPO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPIPO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
