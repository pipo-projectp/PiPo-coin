...
#ifndef PIPOCOIN_ZPIPOTRACKER_H
#define PIPOCOIN_ZPIPOTRACKER_H
...
public:
    CzPIPOTracker(std::string strWalletFile);
    ~CzPIPOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPIPOWallet* zPIPOWallet = NULL);
